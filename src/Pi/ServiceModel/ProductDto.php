...
<<Collection('product')>>
class ProductDto implements IEntity, \JsonSerializable {
  ...
  <<String>>
	...
	public function setLikesCount(string $width) : void
	{
		$this->likesCount = $width;
	}
	...
	public function setCommentsCount(string $width) : void
	{
		$this->commentsCount = $width;
	}

	<<EmbedMany('Pi\ServiceModel\Types\Offer')>>
